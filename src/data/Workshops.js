...
export const WORKSHOPS = [
	...
	// Film Making
	{
		...
		description:
			"Learn more about the real process behind making of a film, use of sounds in films and cinematography. Get Hands on training for use of lights in cinematography. Interactive group discussions on Behind the scenes and making of popular films. Fun and interesting activities on development of a story.",
		regFee: "Rs. 499",
		contact: [
			{
				name: "Nivedita",
				mobile: "+91 63848 56600",
			},
		],
	},
